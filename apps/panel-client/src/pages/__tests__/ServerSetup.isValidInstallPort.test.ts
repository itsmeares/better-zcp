...
// regression lens 4b, previously deferred: apps/panel-server/routes/server.js's
...
// the 39f836f (requireIntInRange, server.js:1741/1745/2244/2248/2422/2500)
...
// FOLLOW-UP (the review of f1ce821): the bare `parseInt(e.target.value) ||
