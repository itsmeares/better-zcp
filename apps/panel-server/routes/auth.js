...
// When trust proxy is configured (apps/panel-server/index.js, TRUST_PROXY env var), the
...
router.post("/setup", setupLimiter, async (req, res) => {
  try {
    ...
    // panel, not this route specifically — see apps/panel-server/utils/setupToken.js.
