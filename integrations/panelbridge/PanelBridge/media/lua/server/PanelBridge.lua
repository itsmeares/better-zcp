...
function PanelBridge.flushResults()
    ...
    -- and auto-updated together in this fork (see apps/panel-server/index.js's
...
-- local-transport commandTimeoutMs (15000, apps/panel-server/services/panelBridge.js
...
handlers.getGameTime = function(args)
    ...
    return true, {
        ...
        -- time-speed slider (apps/panel-client/src/pages/Events.tsx), not a decorative
...
-- apps/panel-client/src/pages/Events.tsx's time-speed slider, which calls
...
-- the "Helicopter" quick-sound button in apps/panel-client/src/pages/Events.tsx calls
...
-- The live path is apps/panel-client/src/pages/WorldMap.tsx's "Spawn Vehicle" tool,
